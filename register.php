...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($fullname) || empty($email) || empty($password) || empty($course)) {
        ...
        $error = "You must agree to the Terms and Conditions to complete registration.";
        ...
        <form method="POST" action="register.php" id="register-form">
            ...
            <div class="form-group">
                ...
                <select name="course" required>
                    ...
                    <option value="Fresh Admission (Beginner)" style="color: black;">Fresh Admission (Beginner)</option>
                    <option value="Prarambhik" style="color: black;">Prarambhik</option>
                    <option value="Praveshika Pratham" style="color: black;">Praveshika Pratham</option>
                    <option value="Praveshika Purna" style="color: black;">Praveshika Purna</option>
                    <option value="Madhyama Pratham" style="color: black;">Madhyama Pratham</option>
                    <option value="Madhyama Purna" style="color: black;">Madhyama Purna</option>
                    <option value="Visharad Pratham" style="color: black;">Visharad Pratham</option>
                    <option value="Visharad Dwitiya" style="color: black;">Visharad Dwitiya</option>
                    <option value="Visharad Tritiya" style="color: black;">Visharad Tritiya</option>
                    <option value="Alankar Pratham" style="color: black;">Alankar Pratham</option>
                </select>
            </div>

            <div class="form-group" style="margin-top: 15px; margin-bottom: 25px; display: flex; align-items: center; gap: 10px;">
                <input type="checkbox" name="terms" id="terms" required style="width: 18px; height: 18px; accent-color: #d4af37; cursor: pointer;">
                <label for="terms" style="margin-bottom: 0; cursor: pointer; color: #ddd; font-size: 0.95rem; display: inline;">I accept the <span style="color: #d4af37; text-decoration: underline;">Terms & Conditions</span> *</label>
            </div>
...
<!-- QR Scanner removed from registration -->
