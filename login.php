...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($email) || empty($password)) {
        ...
        if ($user && password_verify($password, $user['password'])) {
            ...
            if ($remember) {
                // Store remember me credentials in cookies for 30 days
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .portal-wrapper {
            ...
            background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.85)), url('images/slide2.jpg.jpg') center/cover;
        }
        .portal-box {
        ...
        .success-msg {
            background: rgba(77, 255, 128, 0.2);
...
<div class="portal-wrapper">
    <div class="portal-box">
        ...
        <?php if(isset($_SESSION['login_success'])): ?>
            <div class="success-msg"><i class="fa fa-check-circle"></i> <?php echo htmlspecialchars($_SESSION['login_success']); unset($_SESSION['login_success']); ?></div>
        <?php endif; ?>
        
        <form method="POST" action="login.php">
            <div class="form-group">
                <label>Email Address</label>
                <input type="email" name="email" required placeholder="Enter your email" value="<?php echo htmlspecialchars($remembered_email); ?>">
            </div>
            <div class="form-group">
                <label>Password</label>
                <input type="password" name="password" required placeholder="Enter your password" value="<?php echo htmlspecialchars($remembered_password); ?>">
            </div>
            <div class="form-group" style="display: flex; align-items: center; justify-content: space-between; margin-top: -5px; margin-bottom: 20px;">
                <label style="display: flex; align-items: center; gap: 8px; cursor: pointer; color: #ddd; font-size: 0.9rem; margin-bottom: 0;">
                    <input type="checkbox" name="remember" style="width: 16px; height: 16px; accent-color: #d4af37; cursor: pointer;" <?php echo !empty($remembered_email) ? 'checked' : ''; ?>>
                    Remember Me
                </label>
                <a href="forgot-password.php" style="color: #d4af37; font-size: 0.9rem; text-decoration: none;">Forgot Password?</a>
            </div>
